...
// per-column "indexed equality" selectivity fallback (≈ 1/DistinctEstimate) used
// when a per-value frequency cannot be read directly — e.g. the leading column of
// a compound index, whose sketch is keyed on the full composite tuple.
//
